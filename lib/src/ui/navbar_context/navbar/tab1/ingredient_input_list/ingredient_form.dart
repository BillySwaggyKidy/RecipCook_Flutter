            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  Map fieldData = Map.fromEntries(_fieldFormList
                      .map((field) => field.controller.getFieldData())
                      .toList()
                      .where((field) =>
                          field.value.isNotEmpty || field.value != "None"));
                  InheritedNavbar.of(context).fieldData = fieldData;
                  BlocProvider.of<NavbarBloc>(context)
                      .add(NavbarEvent(tabIndex: 1));
                  BlocProvider.of<RecipeItemsBloc>(context).add(
                      RecipeItemsEvent(
                          fieldData: InheritedNavbar.of(context).fieldData));
                }
              },
